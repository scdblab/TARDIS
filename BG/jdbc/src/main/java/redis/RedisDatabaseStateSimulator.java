 ...
 *
 */
public class RedisDatabaseStateSimulator implements Callable<Void> {
	 ...
	 */
	public RedisDatabaseStateSimulator(HashShardedJedis redisClient, AtomicBoolean failed, long[] invtervals) {
		super();
...
//					int count = RedisRecoveryEngine.measureLostWrites(redisClient);
