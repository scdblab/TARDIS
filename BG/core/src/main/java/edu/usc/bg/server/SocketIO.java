...
//		baos.reset();
	...
	public long readLong() throws EOFException, IOException {
		...
		try {
			...
			throw new EOFException("EOF. IP:"+socket.getInetAddress());
	...
	public int sendValue(int i) throws Exception
	{
		try
		{
		...
		{
			throw new Exception(ex.getMessage()+". IP:"+socket.getInetAddress());
