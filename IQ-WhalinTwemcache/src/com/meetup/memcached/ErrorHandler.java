...
public interface ErrorHandler {
    ...
    /**
     * Called for errors thrown during {@link MemcachedClient#hold(String)} and related methods.
     */
    public void handleErrorOnHold( final MemcachedClient client ,
                                   final Throwable error ,
                                   final String cacheKey );
    
    /**
     * Called for errors thrown during {@link MemcachedClient#release(String)} and related methods.
     */
    public void handleErrorOnRelease( final MemcachedClient client ,
                                      final Throwable error ,
                                      final String cacheKey );
